...
const adminRouteGroups = [
  {
    ...
    routes: [
      ["/intelligence/import-trials", "Import Trials"],
      ["/intelligence/import-health", "Import Health"],
      ["/intelligence/repair-wizard", "Repair Wizard"],
      ["/intelligence/review-cockpit", "Review Cockpit"],
    ],
  },
  {
    ...
    routes: [
      ...
      ["/intelligence/admin/broker-mappings", "Broker Mapping Admin"],
    ],
  },
  {
    ...
    routes: [
      ["/intelligence/debug/trade-analysis", "Trade Analysis Debug"],
      ["/intelligence/debug/execution-feedback", "Execution Feedback Debug"],
      ["/intelligence/debug/trader-analytics", "Trader Analytics Debug"],
    ],
  },
] as const;
