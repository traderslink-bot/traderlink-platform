...
export const metadata: Metadata = {
  description: "Learn how to ask about your trading, choose the activity to explore and prepare execution drafts in TraderLink AI Chat.",
  title: "AI Chat Help | TraderLink Platform",
};
...
export default function AiChatHelpPage() {
  return (
    <HelpCollectionOverview
      ...
      href="/help/ai-chat"
      steps={Object.freeze([
        Object.freeze({ title: "Open Chat", description: "Open the companion from any dashboard page or use the direct AI Chat page." }),
