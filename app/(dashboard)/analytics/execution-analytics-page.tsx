...
export async function ExecutionAnalyticsPage({ searchParams }: { searchParams: Readonly<Record<string, string | string[] | undefined>> }) {
  ...
  return <DashboardPage><Box><Typography color="primary.main" sx={{ fontWeight: 800 }} variant="caption">Analytics</Typography><Typography component="h1" sx={{ mt: 0.5 }} variant="h1">Execution</Typography></Box><OverviewDateRangeControl href="/analytics/execution" value={selectedRange} /><ExecutionAnalyticsClient chartData={chartData} rows={rows} /></DashboardPage>;
}
