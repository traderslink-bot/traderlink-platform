  ...
  return <Drawer anchor="right" onClose={onClose} open={open} slotProps={{ paper: { sx: { width: { xs: "100vw", sm: 400 } } } }}>
    <Stack spacing={1.25} sx={{ p: 2 }}>
      ...
      <TextField label="Sort" onChange={(event) => setDraft((value) => ({ ...value, sort: event.target.value as typeof value.sort }))} select size="small" value={draft.sort}>
        <MenuItem value="newest">Newest</MenuItem><MenuItem value="oldest">Oldest</MenuItem><MenuItem value="position">Position</MenuItem><MenuItem value="buy_quantity">Buy QTY</MenuItem><MenuItem value="entry">Entry</MenuItem><MenuItem value="exit">Exit</MenuItem><MenuItem value="entry_value">Entry value</MenuItem><MenuItem value="pnl_high">Gain/Loss high</MenuItem><MenuItem value="pnl_low">Gain/Loss low</MenuItem>
      </TextField>
