...
import {
  positionStatusLabel,
  type PositionStyleDisplay,
} from "../../trade-tracker/position-style-labels";
...
export type OpenPositionTrackingView = Readonly<{
...
export function OpenPositionsView({
  ...
  positionControls?: Readonly<Record<string, ReactNode>>;
  positionStyles: Readonly<Record<string, OpenPositionTrackingView>>;
              ...
              return (
                ...
                >
                  <Stack
                    ...
                    spacing={1}
                    sx={{ alignItems: { sm: "center" }, justifyContent: "space-between", mb: offlineSavedAtUtc ? 0 : 1.5 }}
                  >
                    <Box>
                  ...
                  {!offlineSavedAtUtc ? positionControls?.[position.roundTripId] ?? null : null}
                </Box>
              );
            })}
          </Stack>
