                ...
                <div className="mt-5 grid gap-3">
                  {savedDecisionReview.snapshots.slice(0, 4).map((snapshot) => (
                    <Link
                      ...
                      href={withPageAnchor(
                        `/trades/${encodeURIComponent(snapshot.savedTradeId)}?from=review-queue&queue=completed`,
                        "evidence",
                      )}
                    >
                      <div className="flex items-center justify-between gap-3">
                  ...
                  <div className="mt-3 flex flex-wrap gap-2">
                    {step.relatedTradeIds.slice(0, 5).map((tradeId, tradeIndex) => (
                      <Link
                        ...
                        href={withPageAnchor(`/trades/${encodeURIComponent(tradeId)}`, "writing-flow")}
                      >
