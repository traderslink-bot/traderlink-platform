...
const workspaceNavItems = [
  ...
  },
  {
    href: "#advanced",
    label: "Advanced",
    summary: "Supporting tools and internal workspace notes.",
  },
] as const;
...
export default function WorkspacePage() {
  ...
  const nextReviewHref = rawNextReviewHref.startsWith("/trades/")
    ...
    : rawNextReviewHref;
  const nextActionHref = hasSavedData ? nextReviewHref : "/upload-csv";
  ...
  const calendarHref = latestCalendarMonth
    ? `/trades/calendar?month=${latestCalendarMonth}#calendar`
  ...
  const analyticsHref = hasSavedData ? "/analytics/results" : "/upload-csv";
    ...
    <main className="ti-dashboard-bg min-h-screen px-4 py-5 text-zinc-100 sm:px-6 lg:px-8">
      <div className="mx-auto flex w-full max-w-[1500px] flex-col gap-5">
        <header className="ti-panel flex flex-col gap-4 p-4 sm:p-5 lg:flex-row lg:items-center lg:justify-between">
          ...
          >
            <Link className="ti-top-nav-link" href="/upload-csv">
              Upload
            </Link>
            <Link className="ti-top-nav-link" href={calendarHref}>
              Calendar
            </Link>
            <Link className="ti-top-nav-link" href="/review">
              Review
            </Link>
            <Link className="ti-top-nav-link" href="/analytics">
              Analytics
            </Link>
            <Link className="ti-top-nav-link" href="/coach">
              Coach
            </Link>
          </nav>
        </header>
          ...
          <div className="flex min-w-0 flex-col gap-5">
            ...
            <section className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
              <DashboardMetric
                ...
                href={hasSavedData ? "/trades/round-trips#trade-list" : "/upload-csv"}
                label="Saved Trades"
              ...
              <DashboardMetric
                ...
                href={hasSavedData ? calendarHref : "/upload-csv"}
                label="Day Sessions"
                tone="info"
                value={sessionCount}
              />
              ...
              <DashboardMetric
                ...
                href={hasSavedData ? "/review?queue=market_context_unavailable" : "/upload-csv"}
