...
const ROUTES: Readonly<Record<string, JournalAnalyticsOfflineRouteKind>> = Object.freeze({
  ...
  "/analytics/trade-analyzer/day/trend-momentum": "trade-analyzer-trend-momentum",
...
const TITLES: Readonly<Record<JournalAnalyticsOfflineRouteKind, string>> = Object.freeze({
  ...
  "trade-analyzer-trend-momentum": "Trend & Momentum",
...
const ANALYZER_HELP: Readonly<Record<JournalAnalyticsOfflineRouteKind, string | null>> = Object.freeze({
  ...
  "trade-analyzer-trend-momentum": "/help/trade-analyzer/trend-momentum",
  ...
  return (
    <DashboardPage>
      ...
      {model.kind === "analytics-execution" ? (
        <ExecutionAnalyticsClient chartData={model.chartData} currency={model.currency} moneyBasis={model.moneyBasis} offline priceComparison={model.priceComparison} priceInsights={model.priceInsights} priceResults={model.priceResults} priceResultsByDirection={model.priceResultsByDirection} rows={model.rows} />
      ) : null}
