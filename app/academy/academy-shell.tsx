...
type AcademyAuthSnapshot =
  | { authenticated: false; displayName: null }
  | { authenticated: true; displayName: string };

const storageKey = "traderslink-academy-theme";
const signedOutAuthSnapshot: AcademyAuthSnapshot = {
  authenticated: false,
  displayName: null,
};
...
function getThemeSnapshot(): AcademyTheme {
  const savedTheme = window.localStorage.getItem(storageKey);

  return savedTheme === "dark" || savedTheme === "light" ? savedTheme : "light";
}

function getAuthSnapshotFromResponse(body: unknown): AcademyAuthSnapshot {
