...
| /learn/new-high-of-day/ | docs/content/drafts/learn/new-high-of-day.md | Chart Reading And Market Structure | Day Trading Workflow, Execution And Trade Review | Practical | not_started | full_upgrade | 1 to 2 realistic SVG chart diagrams | No | 1 | Should teach NHOD alerts as context, new-high hold/fail review, nearby resistance, volume quality, and chase-risk review. |  |
...
1. Fetch `/learn/new-high-of-day/` draft.
2. Perform pre-editor review.
3. Upgrade it using the completed high-of-day and breakout articles as the model.
4. Create 1 to 2 realistic SVGs focused on NHOD alert context, breakout hold/fail review, and extension/chase-risk review.
