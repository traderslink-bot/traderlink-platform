...
| 2 | Chart Reading And Market Structure | in_progress | 1 | Support/resistance, how-to-draw support/resistance, and support levels articles complete. Continue with resistance levels. |
...
1. Fetch `/learn/resistance-levels/` draft.
2. Perform pre-editor review.
3. Upgrade it using the completed support/resistance, how-to-draw, and support levels articles as the model.
4. Create 2 to 3 realistic SVGs focused on resistance rejections, resistance breaks, and failed breakouts.
