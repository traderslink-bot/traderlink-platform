...
| /learn/premarket-high-low/ | docs/content/drafts/learn/premarket-high-low.md | Chart Reading And Market Structure | Day Trading Workflow, Execution And Trade Review | Practical | not_started | full_upgrade | 1 to 2 realistic SVG chart diagrams | No | 1 | Should teach premarket high/low as early range reference levels, open-location context, PMH breakout/rejection review, and PML reclaim/breakdown review. |  |
...
1. Fetch `/learn/premarket-high-low/` draft.
2. Perform pre-editor review.
3. Upgrade it using the completed previous-day-level and key-level articles as the model.
4. Create 1 to 2 realistic SVGs focused on premarket range reference levels and open-reaction review.
