...
| /learn/high-of-day/ | docs/content/drafts/learn/high-of-day.md | Chart Reading And Market Structure | Day Trading Workflow, Execution And Trade Review | Practical | not_started | full_upgrade | 1 to 2 realistic SVG chart diagrams | No | 1 | Should teach high of day as an intraday reference level, HOD breakout/rejection review, extended chase risk, and how it relates to PMH/PDH. |  |
...
1. Fetch `/learn/high-of-day/` draft.
2. Perform pre-editor review.
3. Upgrade it using the completed premarket-level and key-level articles as the model.
4. Create 1 to 2 realistic SVGs focused on high-of-day reference level, failed breakout/rejection, and extension-risk review.
