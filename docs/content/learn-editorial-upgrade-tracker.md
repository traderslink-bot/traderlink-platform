...
| 2 | Chart Reading And Market Structure | in_progress | 1 | Support/resistance, how-to-draw support/resistance, support levels, and resistance levels articles complete. Continue with key levels and breakout/breakdown concepts. |
...
| /learn/key-levels-trading/ | docs/content/drafts/learn/key-levels-trading.md | Chart Reading And Market Structure | Start Here For New Traders, Execution And Trade Review | Practical | not_started | full_upgrade | 2 to 3 realistic SVG chart diagrams | No | 1 | Should combine support/resistance into practical decision areas, teach which levels matter now, and bridge into breakout/breakdown/reclaim/rejection review. |  |
...
1. Fetch `/learn/key-levels-trading/` draft.
2. Perform pre-editor review.
3. Upgrade it using the completed support/resistance, level-drawing, support-level, and resistance-level articles as the model.
4. Create 2 to 3 realistic SVGs focused on practical key-level selection, current-plan levels, and level review workflow.
