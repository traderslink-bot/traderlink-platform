...
| 2 | Chart Reading And Market Structure | in_progress | 1 | Support/resistance, level drawing, support levels, resistance levels, and key levels articles complete. Continue with breakout and breakdown concepts. |
...
1. Fetch `/learn/breakout-trading/` draft.
2. Perform pre-editor review.
3. Upgrade it using the completed level-map articles as the model.
4. Create 2 to 3 realistic SVGs focused on clean breakout behavior, failed breakout behavior, and volume/context review.
