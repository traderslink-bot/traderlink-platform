...
| /learn/breakdown-trading/ | docs/content/drafts/learn/breakdown-trading.md | Chart Reading And Market Structure | Day Trading Workflow, Execution And Trade Review | Practical | gap_article_needed | gap_article_needed | 2 realistic SVG chart diagrams | Yes | 1 | Gap article likely needed if no existing Learn draft covers breakdowns directly. Should teach breakdowns as context, failed breakdown/reclaim, extension risk, and review language. |  |
...
1. Check whether `/learn/breakdown-trading/` already exists.
2. Perform pre-editor review.
3. If no draft exists, create it as a Chart Reading gap article.
4. Create 1 to 2 realistic SVGs focused on clean breakdown, failed breakdown/reclaim, and extension-risk review.
