...
| 2 | Chart Reading And Market Structure | in_progress | 1 | Support/resistance, level drawing, support/resistance levels, key levels, breakout trading, level breakout, level reclaim, price rejection, break of structure, swing highs/lows, and higher-high/higher-low articles complete. Continue with downtrend structure, breakdown, fakeout, and intraday level concepts. |
...
| /learn/lower-highs-lower-lows/ | docs/content/drafts/learn/lower-highs-lower-lows.md | Chart Reading And Market Structure | Start Here For New Traders, Execution And Trade Review | Practical | not_started | full_upgrade | 1 to 2 realistic SVG chart diagrams | No | 1 | Should teach downtrend structure, lower-high review, support pressure, breakdown extension risk, and what shifts the structure. |  |
...
1. Fetch `/learn/lower-highs-lower-lows/` draft.
2. Perform pre-editor review.
3. Upgrade it using the completed higher-high/higher-low and swing-point articles as the model.
4. Create 1 to 2 realistic SVGs focused on lower-high/lower-low structure, support pressure, and structure-shift review.
