...
| 2 | Chart Reading And Market Structure | in_progress | 1 | Support/resistance, level drawing, support levels, resistance levels, key levels, and breakout trading articles complete. Continue with level-breakout, breakdown, reclaim, rejection, and fakeout concepts. |
...
| /learn/level-breakout/ | docs/content/drafts/learn/level-breakout.md | Chart Reading And Market Structure | Volume Liquidity And Order Flow, Execution And Trade Review | Practical | not_started | full_upgrade | 2 to 3 realistic SVG chart diagrams | No | 1 | Should focus specifically on breakout level behavior, hold/retest/failure after the break, and how it differs from generic breakout trading. |  |
...
1. Fetch `/learn/level-breakout/` draft.
2. Perform pre-editor review.
3. Upgrade it using the completed breakout trading article as the model.
4. Create 2 to 3 realistic SVGs focused on breakout-level hold, retest, and failed hold behavior.
