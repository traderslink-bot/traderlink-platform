# Small-Cap Stocks, Float And Dilution Lesson-Level Quality Audit
...
Small-Cap Stocks, Float And Dilution is ready as the next major Academy course after News, Catalysts And SEC Filings. The course has the right instructor arc: it starts with small-cap context, moves into float and tradable supply, adds share structure and fully diluted supply, teaches dilution and offering mechanisms, then finishes with securities, corporate actions, cash runway, and going-concern risk.

The course is strongest when it teaches restraint. It does not hype low-float stocks, penny stocks, offerings, warrants, reverse splits, or dilution risk as automatic trade direction. It consistently frames these topics as context to review before and after trades.

The main quality issue was migrated-template wording. Every lesson had the required Academy sections, but many lesson objectives used the same generic language. This pass replaced those with lesson-specific objectives so each lesson now tells the learner exactly what skill they are building.
...
8. A later Accuracy/Source Audit is important because offering mechanics, SEC filing terms, warrants, convertibles, preferred stock, splits, cash runway, and going-concern language can become source-sensitive if exact rules or timing are stated.
...
|---|---|---|---|---|---|
| Small-cap foundation: small-cap stocks and penny stocks | Trade Review | Risk Review / News/Filing Review | Supporting Bridge | Review completed small-cap trades for catalyst quality, liquidity, spread, filings, and whether the trade was reactive. | Completed objective cleanup. |
| Float foundation: stock float, low float, float rotation | Trade Review | Execution Review / Analytics | Core Bridge | Review whether float assumptions, volume participation, spreads, and entry timing helped or hurt the completed trade. | Completed objective cleanup. |
| Share structure: float vs shares outstanding, fully diluted shares, market cap comparison | News/Filing Review | Risk Review / Analytics | Core Bridge | Review whether the trader checked tradable supply, total share count, and potential future shares before relying on float or valuation context. | Removed stale links and hard app routes. |
| Dilution workflow: dilution, dilution risk, spotting dilution risk | News/Filing Review | Risk Review / Trade Review | Core Bridge | Review cash needs, active financing mechanisms, prior offerings, and whether dilution risk was considered before and after the trade. | Completed objective cleanup. |
| Offering module: stock offerings, public offering, registered direct, private placement, ATM, shelf, shelf versus offering | News/Filing Review | Risk Review / Trade Review | Core Bridge | Review offering type, terms, size, pricing, warrants, proceeds, filing source, and market reaction without turning the headline into a signal. | Removed hard app routes and cleaned bridge wording. |
| Securities module: warrants, warrants vs options, pre-funded warrants, convertible notes, preferred stock | News/Filing Review | Risk Review | Core Bridge | Review possible future shares, holder incentives, conversion or exercise terms, and whether the trader understood share-supply risk. | Removed hard app routes and completed objective cleanup. |
| Corporate actions: reverse split, reverse split versus dilution, forward split | News/Filing Review | Liquidity Review / Risk Review | Supporting Bridge | Review split mechanics, liquidity changes, listing context, and whether the trader confused price adjustment with business improvement. | Completed objective cleanup. |
| Risk context: cash runway and going concern | News/Filing Review | Risk Review / Trade Review | Core Bridge | Review cash, burn, obligations, management plans, financing history, and whether financial risk was ignored during strong chart or news action. | Removed hard app routes and cleaned bridge wording. |

## Visual Needs

No new SVGs were created in this pass. The course currently has little direct visual support, so it should receive a dedicated Visual Gap Audit before UI implementation.
...
Visual requirements for any future Small-Cap visuals:

- Use realistic red and green candlesticks when chart reaction is shown.
- Use support/resistance zones, dilution markers, filing panels, offering-term cards, volume bars, or share-supply stacks where useful.
...
- SEC filing and registration mechanics where exact process language appears.
- Offering terminology, shelf registration, prospectus supplement, ATM program, resale registration, and effectiveness language against official SEC sources.
- Warrant, pre-funded warrant, convertible note, and preferred stock descriptions against filing-language examples and securities basics.
- Reverse split, forward split, listing compliance, and delisting context against official exchange or SEC sources if exact rules are used.
- Cash runway and going-concern framing against filing and accounting-source language where exact technical wording matters.

Source-sensitive lessons should avoid exact regulatory timing, deadline, eligibility, or rule claims unless a later source audit verifies them.
...
- Replacing generic migrated lesson objectives with lesson-specific instructional objectives.
...
- Trading halts, volatility halts, halt resumes, market-wide circuit breakers, fast-spread risk, low-float volatility, and high-volatility review.
- A restrained app bridge map centered on Risk Review, Execution Review, Trade Review, Session Review, News/Filing Review, and Analytics.
- Source-sensitive notes for halt, limit-up/limit-down, circuit-breaker, listing, and session-mechanics claims.
