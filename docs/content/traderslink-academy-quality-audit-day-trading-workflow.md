...
- Fix one invalid after-hours related-link target from `/academy/earnings-reports/` to `/academy/earnings-news/`.
...
7. One invalid related link was corrected. After-Hours Trading now points to the local Academy lesson `/academy/earnings-news/`.

## Lesson-Level Notes

| Lesson | Quality Result | Depth | App Bridge Result | Edit Needed |
|---|---|---|---|---|
| `/academy/day-trading-workflow/` | Pass | Strong course opener with full session map and process framing. | Core bridge to Session Review and Trade Review. | No edit needed. |
| `/academy/premarket-trading/` | Pass | Strong preparation lesson with catalyst, PMH/PML, spread, liquidity, and open-transition risk. | Core bridge to Session Review and News/Filing Review. | No edit needed. |
| `/academy/day-trading-watchlist/` | Pass | Strong selection/filter lesson that reduces scanner noise and reactive additions. | Core bridge to Session Review and Trade Review. | No edit needed. |
| `/academy/market-open-trading/` | Pass | Strong market-open lesson with volatility, spread, premarket-level interaction, and failed move review. | Core bridge to Execution Review and Session Review. | No edit needed. |
| `/academy/opening-range/` | Pass | Strong opening-range lesson that avoids mechanical break language. | Core bridge to Trade Review and Execution Review. | No edit needed. |
| `/academy/midday-trading/` | Pass | Strong filtering lesson around low-volume chop, boredom, and forced trades. | Core bridge to Coaching and Session Review. | No edit needed. |
| `/academy/power-hour-trading/` | Pass | Strong final-hour reassessment lesson with emotional and close-planning context. | Core bridge to Session Review and Coaching. | No edit needed. |
| `/academy/after-hours-trading/` | Pass after cleanup | Strong extended-hours lesson with headline/source, spread, liquidity, and overnight-risk context. | Core bridge to News/Filing Review and Risk Review. | Fixed invalid earnings link. |
| `/academy/day-trading-session-review/` | Pass | Strong capstone that turns the workflow into process review. | Core bridge to Session Review, Trade Review, and Analytics. | No edit needed. |

## App Bridge Map

| Lesson | Primary App Surface | Secondary App Surface | Bridge Strength | Natural Tie-In | Needed Edit |
|---|---|---|---|---|---|
| `/academy/day-trading-workflow/` | Session Review | Trade Review | Core Bridge | Review completed trades by session segment, setup type, risk, execution, and behavior. | None. |
| `/academy/premarket-trading/` | Session Review | News/Filing Review | Core Bridge | Review whether premarket trades came from catalyst/source prep or excitement. | None. |
| `/academy/day-trading-watchlist/` | Session Review | Trade Review | Core Bridge | Review planned watchlist trades versus reactive additions. | None. |
| `/academy/market-open-trading/` | Execution Review | Session Review | Core Bridge | Review open trades by timing, premarket levels, spread, slippage, and pressure behavior. | None. |
| `/academy/opening-range/` | Trade Review | Execution Review | Core Bridge | Review opening-range entries by time window, range width, hold/failure, and risk distance. | None. |
| `/academy/midday-trading/` | Coaching | Session Review | Core Bridge | Review boredom trades, low-volume chop, repeated entries, and giveback patterns. | None. |
| `/academy/power-hour-trading/` | Session Review | Coaching | Core Bridge | Review final-hour trades by volume return, close plan, frustration, and forced decisions. | None. |
| `/academy/after-hours-trading/` | News/Filing Review | Risk Review | Core Bridge | Review headline/source quality, spread, liquidity, and overnight exposure after the close. | Fixed invalid related lesson link. |
| `/academy/day-trading-session-review/` | Session Review | Analytics | Core Bridge | Review session segments, repeated mistakes, strengths, and next-session adjustments. | None. |
...
- Fixing an invalid related lesson link from `/academy/earnings-reports/` to `/academy/earnings-news/`.
