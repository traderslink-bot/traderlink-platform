...
This document turns the TradersLink `/academy/` content library into a structured educational journey for real users.
...
| 2 | Trading Plan | `/glossary/trading-plan/` or `/academy/trading-plan/` | Foundation | Teaches that trading should have structure before action. | Trade Rules |
...
| 5 | Risk Management | `/glossary/risk-management/` or `/academy/risk-management/` | Foundation | Teaches that protecting downside comes before chasing upside. | Position Sizing |
...
This should be the first visible path on `/academy/`:
...
| Order | Article/Term | Preferred URL | Level | Why It Belongs Here | Next Step |
|---:|---|---|---|---|---|
| 1 | Support And Resistance | `/academy/support-and-resistance/` | Foundation | Core chart concept. | How To Draw Support And Resistance |
| 2 | How To Draw Support And Resistance | `/academy/how-to-draw-support-and-resistance/` | Practical | Shows how to apply the concept. | Support Level |
...
| Order | Article/Term | Preferred URL | Level | Why It Belongs Here | Next Step |
|---:|---|---|---|---|---|
| 1 | Candlestick Patterns Hub | `/academy/candlestick-patterns/` | Foundation | Introduces the family. | Doji |
| 2 | Doji | `/academy/candlestick-patterns/doji/` | Foundation | Teaches indecision. | Spinning Top |
| 3 | Spinning Top | `/academy/candlestick-patterns/spinning-top/` | Foundation | Similar indecision concept. | Long Wick Candle |
| 4 | Long Wick Candle | `/academy/candlestick-patterns/long-wick-candle/` | Practical | Introduces rejection/wicks. | Hammer |
| 5 | Hammer | `/academy/candlestick-patterns/hammer/` | Practical | Bullish reversal context. | Inverted Hammer |
| 6 | Inverted Hammer | `/academy/candlestick-patterns/inverted-hammer/` | Practical | Related reversal candle. | Shooting Star |
| 7 | Shooting Star | `/academy/candlestick-patterns/shooting-star/` | Practical | Bearish rejection context. | Engulfing Candle |
| 8 | Engulfing Candle | `/academy/candlestick-patterns/engulfing-candle/` | Foundation | Parent concept. | Bullish Engulfing |
| 9 | Bullish Engulfing | `/academy/candlestick-patterns/bullish-engulfing/` | Practical | Bullish context. | Bearish Engulfing |
| 10 | Bearish Engulfing | `/academy/candlestick-patterns/bearish-engulfing/` | Practical | Bearish context. | Topping Tail |
| 11 | Topping Tail | `/academy/candlestick-patterns/topping-tail/` | Practical | Rejection at highs. | Bottoming Tail |
| 12 | Bottoming Tail | `/academy/candlestick-patterns/bottoming-tail/` | Practical | Rejection at lows. | Red To Green Move |
| 13 | Red To Green Move | `/academy/candlestick-patterns/red-to-green-move/` | Advanced | Connects candle behavior and intraday momentum. | Green To Red Move |
| 14 | Green To Red Move | `/academy/candlestick-patterns/green-to-red-move/` | Advanced | Opposite intraday shift. | Candle Volume Confirmation |
| 15 | Candle Volume Confirmation | `/academy/candlestick-patterns/candle-volume-confirmation/` | Review | Teaches volume confirmation and review. | Trade Review |
...
| Order | Article/Term | Preferred URL | Level | Why It Belongs Here | Next Step |
|---:|---|---|---|---|---|
| 1 | Volume | `/academy/volume/` | Foundation | Basic market participation concept. | Relative Volume |
| 2 | Relative Volume | `/glossary/relative-volume/` or `/academy/relative-volume/` | Practical | Shows unusual attention. | Volume Spike |
| 3 | Volume Spike | `/glossary/volume-spike/` or `/academy/volume-spike/` | Practical | Teaches sudden activity. | Liquidity |
...
| 3 | Stock Catalysts | `/academy/stock-catalysts/` | Practical | Broader catalyst guide. | Contract News |
...
| 8 | SEC Filings Hub | `/academy/sec-filings/` | Foundation | Introduces filings. | Current Report |
...
| Order | Article/Term | Preferred URL | Level | Why It Belongs Here | Next Step |
|---:|---|---|---|---|---|
| 1 | Small-Cap Stocks | `/academy/small-cap-stocks/` | Foundation | Introduces small-cap context. | Penny Stocks |
| 2 | Penny Stocks | `/academy/penny-stocks/` | Foundation | High-risk low-priced context. | Float |
...
This should appear as a guided selector on `/academy/`:
...
## Recommended `/academy/` Page Layout For Codex
...
/academy/
  ...
  /academy/volume-liquidity-order-flow/
  /academy/news-catalysts-filings/
  /academy/risk-discipline/
  /academy/day-trading-workflow/
  /academy/trade-review/
  /academy/practice-and-improvement/
```

These can be hub pages later. For now, this document defines the intended structure.

### Relationship Between `/academy/` And `/glossary/`

Use `/academy/` for guided explanations and learning paths.
...
Codex should create a `/academy/` page that shows:
...
1. `/academy/start-here/` | Start Here For New Traders.
2. `/academy/how-to-use-this-learning-library/` | How to use TradersLink Learn.
3. `/academy/chart-reading-path/` | Chart reading learning path.
4. `/academy/news-and-filings-path/` | News and filings learning path.
5. `/academy/trade-review-path/` | Trade review learning path.
6. `/academy/risk-discipline-path/` | Risk and discipline learning path.
7. `/academy/trading-practice-path/` | Practice and improvement learning path.
