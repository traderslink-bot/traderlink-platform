# News, Catalysts And SEC Filings Lesson-Level Quality Audit
...
News, Catalysts And SEC Filings is ready as a major Academy course after Swing Trading Workflow. The course succeeds because it teaches users to slow down, verify source detail, compare headlines against filings, and review market reaction without treating news as a direction call.

The instructor flow is strong:

1. Open with catalyst quality and headline-versus-reaction context.
2. Teach press releases as company communication that must be read beyond the headline.
3. Teach SEC filings as source documents and then EDGAR as the verification workflow.
4. Move through current-event, financial-report, registration, prospectus, ownership, proxy, late-filing, and delisting filing types.
5. Return to common news categories: earnings, FDA, clinical trial, contract, partnership, and merger news.
6. Close with a capstone lesson on reviewing news trades by catalyst quality, chart reaction, risk, liquidity, execution, and repeated behavior patterns.

The course does not need a broad rewrite. It does need continued source discipline in later passes because SEC, EDGAR, FDA, and filing-rule details are source-sensitive.
...
7. Broad journal wording was cleaned where the lesson was not specifically about journaling. The course now uses review notes / structured review wording except for the legitimate phrase "medical journal" inside the clinical trial lesson.
8. A later Accuracy/Source Audit is still required for official SEC, EDGAR, FDA, PDUFA, clinical trial, filing deadline, and delisting/listing-rule specifics.
...
|---|---|---|---|---|---|
| Stock Catalysts | News/Filing Review | Trade Review | Core Bridge | Review catalyst category, source, detail quality, reaction, liquidity, and whether the trader chased a headline. | None. |
| Press Releases | News/Filing Review | Trade Review | Core Bridge | Review source, timestamp, detail quality, related filings, and headline-versus-reaction behavior. | Cleaned generic journal wording. |
| How To Read Stock Press Releases | News/Filing Review | Risk Review | Core Bridge | Review whether the trader read the release body, checked filings, and understood the actual announcement before entry. | None. |
| SEC Filings Hub | News/Filing Review | Risk Review | Core Bridge | Review form type, filing detail, dilution language, timing, volume reaction, and whether filing research happened before the trade. | Cleaned generic journal wording. |
| EDGAR Source Documents | News/Filing Review | Journal Notes | Core Bridge | Review whether official SEC source documents, exhibits, accepted time, and related filings were checked. | None. |
| Current Reports: 8-K / 6-K | News/Filing Review | Trade Review | Core Bridge | Review current-event filings, exhibits, foreign issuer updates, and whether the event changed the trade thesis. | Removed stale hard app route links from 6-K. |
| Company Reports: 10-K / 10-Q / 20-F | News/Filing Review | Risk Review | Supporting Bridge | Review cash, risk factors, going concern, debt, losses, and share-structure context behind later trades. | Removed stale hard app route links and cleaned objective wording. |
| Registration Statements: S-1 / S-3 / F-1 / F-3 | News/Filing Review | Risk Review | Core Bridge | Review registered securities, resale context, shelf availability, prospectus supplements, and future offering risk. | Removed stale hard app route links where present. |
| Transaction / Benefit Registrations: S-4 / S-8 | News/Filing Review | Risk Review | Supporting Bridge | Review merger securities, exchange offers, benefit-plan shares, and supply context. | Removed stale hard app route links and cleaned objective wording. |
| Prospectus Supplements: 424B5 / 424B3 / 424B4 / EFFECT | News/Filing Review | Risk Review | Core Bridge | Review offering terms, resale context, effectiveness timeline, underwriters, proceeds, warrants, and selling pressure risk. | Removed stale hard app route links where present. |
| Ownership: Form 3 / 4 / 5 / 13D / 13G | News/Filing Review | Analytics | Supporting Bridge | Review insider or beneficial ownership context without treating ownership filings as trade confirmation. | Removed stale hard app route links and fixed internal link targets. |
| Proxy / Late / Listing: DEF 14A / PRE 14A / NT 10-K / NT 10-Q / Form 25 | News/Filing Review | Risk Review | Supporting Bridge | Review proposed votes, late filing reasons, reporting risk, delisting context, and liquidity/access changes. | Removed stale hard app route links and cleaned objective wording. |
| News Categories: Earnings / FDA / Clinical / Contract / Partnership / Merger | News/Filing Review | Trade Review | Core Bridge | Review event type, source detail, expected-versus-surprise status, filing context, price reaction, liquidity, and execution. | None. |
| How To Review News Trades | Trade Review | News/Filing Review / Analytics | Core Bridge | Review news trades by catalyst quality, chart reaction, liquidity, risk, execution, and repeat patterns. | Cleaned broad journal SEO phrase. |
...
Visual requirements for any future News/Catalysts/SEC visuals:

- Use realistic red and green candlesticks when chart reaction is shown.
- Use source-document panels, filing timelines, catalyst cards, volume bars, and review notes where useful.
...
This pass was a lesson-level quality audit, not the official Accuracy/Source Audit. No broad official-source verification was completed in this run.

Future Accuracy/Source Audit should verify:

- SEC EDGAR navigation and search wording.
- Current SEC form descriptions where timing, eligibility, or filing mechanics are stated.
- Form 8-K, 10-K, 10-Q, S-1, S-3, 424B filings, EFFECT notices, Forms 3/4/5, Schedules 13D/13G, proxy filings, late filing notices, and Form 25 details against official SEC or exchange sources.
- FDA, PDUFA, clinical trial phase, Fast Track, orphan drug, and regulatory milestone language against official FDA sources where the lesson becomes more rule-specific.
- Delisting/listing-rule language against official exchange or SEC sources if the lesson adds exact timing or process rules.

Source-sensitive lessons should avoid exact regulatory timing, deadline, eligibility, or rule claims unless the later source audit verifies them.
...
- Replacing broad journal wording with review-notes wording where the lesson was not specifically about journaling.
- Removing hard `/trader-intelligence/` app route links from SEC filing module lessons.
- Replacing generic product copy with restrained filing-review support language.
- Fixing several stale internal lesson targets in SEC filing module files.
- Cleaning compressed lesson objective bullets in SEC filing module files.
...
- Small-cap stocks, penny stocks, float, low float, float rotation, shares outstanding, fully diluted shares, dilution, offerings, warrants, convertibles, preferred stock, reverse splits, cash runway, going concern, and related dilution-risk lessons.
- A restrained app bridge map centered on News/Filing Review, Risk Review, Trade Review, Analytics, Journal Notes, and Playbook Builder.
- Source-sensitive notes for offerings, dilution, share structure, cash runway, going concern, and SEC-related claims.
