...
| academy_format_review_needed | 17 | Remaining upgraded lessons should still receive a final Academy migration pass for metadata, course/module/order, completion assumptions, and section naming. |
| academy_ready | 200 | Chart Reading core, Candlestick Patterns, Chart Patterns, Volume/Liquidity, Technical Indicators, Trading Styles, News/SEC Filings, Risk Management, Small-Cap/Float/Dilution, Trading Psychology, Trade Review, Day Trading Workflow, Practice/Improvement, and Halts/High-Volatility lesson sets have passed the first Academy format migration check. |
...
```text
Swing Trading Workflow Academy format migration
```

Reason:

Trading Foundations passed the first structural check. Chart Reading core, Candlestick Patterns, Chart Patterns, Volume/Liquidity, Technical Indicators, Trading Styles, News/SEC Filings, Risk Management, Small-Cap/Float/Dilution, Trading Psychology, Trade Review, Day Trading Workflow, Practice/Improvement, and Halts/High-Volatility have completed the first Academy format migration check. The highest-value next work is Swing Trading Workflow.
