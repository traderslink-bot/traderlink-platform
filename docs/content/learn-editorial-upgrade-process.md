...
This document defines the full editorial workflow for turning the TradersLink `/academy/` content library into a guided educational learning journey.
...
```text
/academy/start-here/
/academy/how-to-use-traderslink-learn/
/academy/chart-reading-path/
/academy/news-and-filings-path/
/academy/trade-review-path/
/academy/risk-discipline-path/
/academy/practice-and-improvement-path/
```
...
Upgrade one key article completely, recommended `/academy/support-and-resistance/`.
...
After planning and content upgrades are stable, Codex can build the `/academy/` guided hub, learning path cards, path selector, track hub pages, previous/next article components, optional visual rendering, and optional metadata-driven navigation.
