...
secondary_keywords:
  - "maximum loss trading"
  - "trading max loss rule"
  - "daily max loss"
  - "loss limit trading"
search_intent: "Understand what max loss means in trading, why traders use max loss rules, and how to review max loss discipline."
status: "draft"
...
This lesson is part of the **Risk Management And Trade Planning** course. It follows [Mental Stop Vs Hard Stop](/learn/mental-stop-vs-hard-stop/) and leads into [Daily Loss Limit](/learn/daily-loss-limit/).
...
For Max Loss, the useful review is not whether one trade made money. The better review is whether the decision was planned, controlled, and repeatable.
