...
visual_assets:
  - "/images/learn/chart-reading/price-rejection-at-resistance.svg"
  - "/images/learn/chart-reading/rejection-wick-context.svg"
internal_links:
...
![Candlestick chart showing price pushing into resistance and rejecting back below the zone.](/images/learn/chart-reading/price-rejection-at-resistance.svg)
...
![Candlestick chart showing a long wick at a key level with follow-through context.](/images/learn/chart-reading/rejection-wick-context.svg)
...
- What level rejected price?
- Did I know that level before the trade?
- Did I enter before or after the rejection candle?
- Did the rejection invalidate my trade idea?
- Did I exit according to plan or freeze?
- Did price later reclaim the rejected level?
...
2. [Level Breakout](/learn/level-breakout/)

Recommended next lessons:

1. [Break of Structure](/learn/break-of-structure/)
2. [Long Wick Candle](/learn/candlestick-patterns/long-wick-candle/)
3. [Resistance Levels](/learn/resistance-levels/)
