...
search_intent: "Understand what unusual volume stocks are, why traders watch them, and how to review abnormal activity with catalyst, liquidity, and price-action context."
status: "draft"
...
meta_title: "Unusual Volume Stocks Explained"
...
This is why [Liquidity](/learn/liquidity/) and [Spread](/learn/spread/) belong in the same review. A trader can be right that volume is abnormal and still get poor execution if the stock is too thin, too fast, or too crowded.
