...
secondary_keywords:
  ...
  - "unusual volume"
search_intent: "Learn what relative volume means, why traders compare current activity to normal activity, and how to review high-relative-volume trades."
status: "draft"
...
meta_title: "Relative Volume Explained for Traders"
...
- [Relative Volume RVOL](/learn/relative-volume-rvol/) for metric-specific RVOL review.
- [Volume Spike](/learn/volume-spike/) for sudden bursts in activity.
- [Liquidity](/learn/liquidity/) for execution quality.
- [Low-Float Stocks](/learn/low-float-stocks/) for fast-moving small-cap context.
- [Stock Catalysts](/learn/stock-catalysts/) for why activity appears.
