...
visual_assets:
  - "/images/learn/chart-reading/bid-ask-quote-mechanics.svg"
  - "/images/learn/chart-reading/bid-ask-order-interaction-review.svg"
internal_links:
  - "/learn/spread/"
  - "/learn/liquidity/"
  - "/learn/slippage/"
...
![Trading dashboard showing bid, ask, spread, last price, and nearby quote depth.](/images/learn/chart-reading/bid-ask-quote-mechanics.svg)
...
![Trading dashboard showing how immediate orders interact with bid and ask quotes.](/images/learn/chart-reading/bid-ask-order-interaction-review.svg)
...
- [Market Orders Vs Limit Orders](/learn/market-orders-vs-limit-orders/) to connect order type with quote behavior.
- [Level 2](/learn/level-2/) to understand deeper quote context.
- [Spread](/learn/spread/) to review the gap between buyers and sellers.
- [Liquidity](/learn/liquidity/) to understand whether the quote has enough depth.
