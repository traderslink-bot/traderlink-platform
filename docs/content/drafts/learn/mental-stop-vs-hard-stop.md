...
secondary_keywords:
  ...
  - "stop loss trading"
  - "trading stop types"
search_intent: "Understand the difference between a mental stop and a hard stop, the risks of each, and how traders can review stop discipline."
status: "draft"
...
recommended_next: "/learn/max-loss/"
recommended_previous: "/learn/stop-loss/"
...
This lesson is part of the **Risk Management And Trade Planning** course. It follows [Stop Loss](/learn/stop-loss/) and leads into [Max Loss](/learn/max-loss/).
...
For Mental Stop Vs Hard Stop, the useful review is not whether one trade made money. The better review is whether the decision was planned, controlled, and repeatable.
