...
visual_assets:
  - "/images/learn/chart-reading/dollar-volume-share-vs-value-comparison.svg"
  - "/images/learn/chart-reading/dollar-volume-low-price-liquidity-review.svg"
internal_links:
  - "/learn/volume/"
...
![Trading dashboard comparison showing high share volume versus higher dollar volume.](/images/learn/chart-reading/dollar-volume-share-vs-value-comparison.svg)
...
![Trading dashboard showing low-priced stock dollar volume with spread and depth review context.](/images/learn/chart-reading/dollar-volume-low-price-liquidity-review.svg)

This is why dollar volume should be reviewed with [Liquidity](/learn/liquidity/), [Spread](/learn/spread/), and [Slippage](/learn/slippage/).
...
- [Spread](/learn/spread/) to understand the bid-ask cost of entering and exiting.
- [Bid And Ask](/learn/bid-and-ask/) to understand quote mechanics.
- [Slippage](/learn/slippage/) to review worse-than-expected fills.
- [Market Orders Vs Limit Orders](/learn/market-orders-vs-limit-orders/) to connect order type with execution.
- [Low-Float Stocks](/learn/low-float-stocks/) to understand why some small caps move quickly.
