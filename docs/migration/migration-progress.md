...
**Currency preference and reporting:** The owner authorized a user-selected Account Settings reporting currency on 2026-08-05 and expanded it dashboard-wide on 2026-08-16. Journal executions retain their exact recorded currencies; normal Workspace, Calendar, Analytics, Trade Analyzer, Trade Tracker, Rules-result, Open Position and Candle Review money is converted server-side before presentation using cached effective-dated Bank of Canada indicative rates. Manual/import/Data Decision source values and already-issued AI Review prose remain original evidence. Missing exact coverage is unavailable rather than relabelled. The [Currency Preference And Reporting Plan](currency-preference-and-reporting-plan.md) and [progress record](currency-preference-and-reporting-progress.md) control this Platform-owned preference slice.
