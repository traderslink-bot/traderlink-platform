...
- [x] Hide the Workspace install card when Chrome recognizes that TradersLink is already installed. Account retains device-data settings without an install action in that state.
