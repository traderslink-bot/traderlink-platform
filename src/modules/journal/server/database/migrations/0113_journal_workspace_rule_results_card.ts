...
const sql = `CREATE TABLE journal_workspace_rule_results_card_preferences (
...
export const journalWorkspaceRuleResultsCardMigration: PlatformMigration = Object.freeze({
  moduleNamespace: "journal",
  migrationId: "0113_journal_workspace_rule_results_card",
  executionOrder: 113,
