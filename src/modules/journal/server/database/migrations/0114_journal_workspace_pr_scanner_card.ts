...
const sql = `CREATE TABLE journal_workspace_pr_scanner_card_preferences (
...
export const journalWorkspacePrScannerCardMigration: PlatformMigration = Object.freeze({
  moduleNamespace: "journal",
  migrationId: "0114_journal_workspace_pr_scanner_card",
  executionOrder: 114,
