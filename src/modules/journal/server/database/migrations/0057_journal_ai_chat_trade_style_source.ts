...
DROP TRIGGER journal_trade_style_plans_no_delete;
DROP TRIGGER journal_trade_style_plan_events_no_update;
DROP TRIGGER journal_trade_style_plan_events_no_delete;
DROP INDEX journal_trade_style_plans_account_state;
DROP INDEX journal_trade_style_plans_open_status;
DROP INDEX journal_trade_style_plan_events_chronology;

ALTER TABLE journal_trade_style_plans RENAME TO journal_trade_style_plans_0057_old;
ALTER TABLE journal_trade_style_plan_events RENAME TO journal_trade_style_plan_events_0057_old;
...
CREATE TABLE journal_trade_style_plan_events (
  ...
  source_ui TEXT NOT NULL CHECK (source_ui IN ('day_trade_tracker', 'swing_trade_tracker', 'open_positions', 'ai_chat')),
...
INSERT INTO journal_trade_style_plans SELECT * FROM journal_trade_style_plans_0057_old;
INSERT INTO journal_trade_style_plan_events SELECT * FROM journal_trade_style_plan_events_0057_old;
DROP TABLE journal_trade_style_plan_events_0057_old;
DROP TABLE journal_trade_style_plans_0057_old;
...
export const journalAiChatTradeStyleSourceMigration: PlatformMigration = Object.freeze({
  moduleNamespace: "journal",
  migrationId: "0057_journal_ai_chat_trade_style_source",
  executionOrder: 57,
