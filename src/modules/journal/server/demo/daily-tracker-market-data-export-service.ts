...
const ALLOWED_SESSIONS = Object.freeze(new Map<string, ReadonlySet<string>>([
  ["2026-08-03", new Set(["RITR", "HYFM"])],
  ["2026-08-04", new Set(["AMIX", "QNME"])],
  ["2026-08-05", new Set(["YXT", "INLF"])],
  ["2026-08-06", new Set(["MBAI", "PFSA"])],
  ["2026-08-07", new Set(["YJ", "MB"])],
  ["2026-08-10", new Set(["SCKT", "JWEL"])],
  ["2026-08-11", new Set(["PFSA", "WXM"])],
  ["2026-08-12", new Set(["BOXL", "RMCF"])],
  ["2026-08-13", new Set(["XHG", "FGI"])],
  ["2026-08-14", new Set(["WETO", "MDXH"])],
  ["2026-08-28", new Set(["FTFT", "FNGR"])],
  ["2026-08-31", new Set(["AEHL", "NCRA"])],
]));
