...
const DEMO_PACK_VERSION_IDS = Object.freeze({
  ...
  11: "a2703b8c-41a7-48ac-8a1c-62f7695ed6f1",
  12: JOURNAL_DEMO_CURRENT_VERSION_ID,
});
...
const DEMO_DAILY_NOTE = Object.freeze({
  ...
  tomorrowsFocus: "Your Current Focuses note is captured on every Session Tracker so you can review it alongside your trading results. Write down the habits, rules, or areas of your trading you are actively working on. Because your focuses carry beyond a single trading day, seeing them during each daily review helps keep them front and center and lets you judge whether your actual decisions are improving in the areas you chose to work on.",
