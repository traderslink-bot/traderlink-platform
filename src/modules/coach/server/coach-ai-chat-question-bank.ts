...
const firstBatch = Object.freeze([
  ...
  createCase({ id: "links-core-march-gross-loss", batch: 1, family: "performance", question: "how much did i lose in march 2026", scopeKind: "named_month", answerKind: "direct_fact", expectedToolNames: ["summarize_closed_trades"], requiredFacts: ["net realized profit and loss", "March 2026 scope"] }),
  createCase({ id: "links-core-march-gross-profit", batch: 1, family: "performance", question: "how much did i make in march 2026", scopeKind: "named_month", answerKind: "direct_fact", expectedToolNames: ["summarize_closed_trades"], requiredFacts: ["net realized profit and loss", "March 2026 scope"] }),
  ...
  createCase({ id: "links-core-march-best-day", batch: 1, family: "timing", question: "what was my best trading day in march 2026", scopeKind: "named_month", answerKind: "ranked_facts", expectedToolNames: ["get_analytics_overview"], requiredFacts: ["trading day", "net profit and loss", "March 2026 scope"] }),
  createCase({ id: "links-core-march-worst-day", batch: 1, family: "timing", question: "what was my worst trading day in march 2026", scopeKind: "named_month", answerKind: "ranked_facts", expectedToolNames: ["get_analytics_overview"], requiredFacts: ["trading day", "net profit and loss", "March 2026 scope"] }),
