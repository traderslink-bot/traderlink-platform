...
CREATE TABLE platform_notifications_0063 (
  ...
  category TEXT NOT NULL CHECK (category IN (
    'ai_review', 'broker_connection', 'broker_import', 'chart_update',
    'data_decision', 'statement_import'
  )),
...
INSERT INTO platform_notifications_0063 (
...
CREATE TABLE platform_notification_receipts_0063 (
  ...
  FOREIGN KEY (notification_id) REFERENCES platform_notifications_0063(notification_id)
    ON UPDATE RESTRICT ON DELETE RESTRICT,
  FOREIGN KEY (recipient_user_id) REFERENCES platform_users(user_id)
    ON UPDATE RESTRICT ON DELETE RESTRICT
) STRICT, WITHOUT ROWID;

INSERT INTO platform_notification_receipts_0063 (
...
CREATE TABLE platform_notification_delivery_preferences_0063 (
...
INSERT INTO platform_notification_delivery_preferences_0063 (
  user_id, category, discord_dm_enabled, updated_at_utc
)
SELECT user_id, category, discord_dm_enabled, updated_at_utc
...
ALTER TABLE platform_notifications_0063 RENAME TO platform_notifications;
ALTER TABLE platform_notification_receipts_0063 RENAME TO platform_notification_receipts;
ALTER TABLE platform_notification_delivery_preferences_0063 RENAME TO platform_notification_delivery_preferences;
...
export const platformNotificationCoverageMigration: PlatformMigration = Object.freeze({
  moduleNamespace: "platform",
  migrationId: "0063_platform_notification_coverage",
  executionOrder: 63,
