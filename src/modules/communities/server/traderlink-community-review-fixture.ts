...
export function createTraderLinkCommunityReviewFixture(role:TraderLinkCommunityReviewRole="owner"): TraderLinkCommunityDashboardSnapshot {
  ...
  const snapshot: TraderLinkCommunityDashboardSnapshot = {
    ...
    plans: Object.freeze([
      ...
      { planId:"10000000-0000-4000-8000-000000000017",coachProfileId:COACH_PROFILE_ID,communityId:COMMUNITY_ID,name:"Weekly Trade Review",description:"One focused review each week for traders who want regular feedback.",cadence:"weekly",tradeReviewLimit:1,studentCapacity:8,messagingIncluded:false,tradeReviewsIncluded:true,sessionsIncluded:false,teachingIncluded:true,priceLabel:"$55 / week",paymentInstructions:"Contact the coaching team in Discord to arrange access.",audienceId:EVERYONE_ID,status:"active" },
    ]),
    ...
    coachingAttachments:Object.freeze([{attachmentId:"10000000-0000-4000-8000-000000000054",relationshipId:RELATIONSHIP_ID,uploadedByUserId:COACH_ID,targetType:"review",targetId:"10000000-0000-4000-8000-000000000035",filename:"nvda-markup.png",mediaType:"image/png",byteLength:248120,createdAtUtc:"2026-09-05T13:26:00.000Z",href:"/api/communities/review/coaching/attachments/10000000-0000-4000-8000-000000000054"}]),
