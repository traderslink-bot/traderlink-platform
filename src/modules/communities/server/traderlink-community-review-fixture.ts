...
export function createTraderLinkCommunityReviewFixture(role:TraderLinkCommunityReviewRole="owner"): TraderLinkCommunityDashboardSnapshot {
  ...
  const snapshot: TraderLinkCommunityDashboardSnapshot = {
    ...
    plans: Object.freeze([
      { planId:PLAN_ID,coachProfileId:COACH_PROFILE_ID,communityId:COMMUNITY_ID,name:"Momentum Accountability",description:"A practical monthly coaching relationship built around preparation, execution, and review.",cadence:"monthly",tradeReviewLimit:4,studentCapacity:24,messagingIncluded:true,tradeReviewsIncluded:true,sessionsIncluded:true,teachingIncluded:true,priceLabel:"$149 / month",paymentInstructions:"Payment and the coaching role are handled in the Momentum Trading Room Discord.",priceAmountMinor:14900,currency:"USD",billingCadence:"monthly",quoteRequired:false,requiredDiscordRoleId:"910002",autoArchiveAfterDays:null,planStyle:"structured",items:Object.freeze([{planItemId:"10000000-0000-4000-8000-000000000061",itemType:"trade_review",frequency:"weekly",coveragePeriod:"previous_7_days",quantity:4,dueOffsetDays:2,selectionMode:"coach_or_student",followUpDays:0,measurementKind:"trades",plannedMinutes:null,timelineEnabled:true,reviewDepth:"standard",ordinal:0},{planItemId:"10000000-0000-4000-8000-000000000062",itemType:"performance_review",frequency:"monthly",coveragePeriod:"previous_month",quantity:1,dueOffsetDays:3,selectionMode:"not_applicable",followUpDays:0,measurementKind:"reviews",plannedMinutes:60,timelineEnabled:true,reviewDepth:"standard",ordinal:1},{planItemId:"10000000-0000-4000-8000-000000000063",itemType:"review_follow_up",frequency:"weekly",coveragePeriod:"single_item",quantity:1,dueOffsetDays:2,selectionMode:"not_applicable",followUpDays:3,measurementKind:"questions",plannedMinutes:null,timelineEnabled:true,reviewDepth:"standard",ordinal:2}] as const),journalScopes:Object.freeze([{dataScope:"trades",required:true},{dataScope:"analytics",required:true},{dataScope:"rules",required:true}] as const),audienceId:PREMIUM_ID,status:"active" },
      { planId:"10000000-0000-4000-8000-000000000017",coachProfileId:COACH_PROFILE_ID,communityId:COMMUNITY_ID,name:"Weekly Trade Review",description:"One focused review each week for traders who want regular feedback.",cadence:"weekly",tradeReviewLimit:1,studentCapacity:8,messagingIncluded:false,tradeReviewsIncluded:true,sessionsIncluded:false,teachingIncluded:true,priceLabel:"$55 / week",paymentInstructions:"Contact the coaching team in Discord to arrange access.",priceAmountMinor:5500,currency:"USD",billingCadence:"weekly",quoteRequired:false,requiredDiscordRoleId:"910002",autoArchiveAfterDays:60,planStyle:"structured",items:Object.freeze([{planItemId:"10000000-0000-4000-8000-000000000064",itemType:"trade_review",frequency:"weekly",coveragePeriod:"since_last_review",quantity:1,dueOffsetDays:2,selectionMode:"student",followUpDays:0,measurementKind:"trades",plannedMinutes:null,timelineEnabled:true,reviewDepth:"standard",ordinal:0}] as const),journalScopes:Object.freeze([{dataScope:"trades",required:true}] as const),audienceId:EVERYONE_ID,status:"active" },
    ]),
    relationships: Object.freeze([{ relationshipId:RELATIONSHIP_ID,communityId:COMMUNITY_ID,coachProfileId:COACH_PROFILE_ID,coachUserId:COACH_ID,coachDisplayName:"Maya Chen",studentUserId:STUDENT_ID,studentDisplayName:"Alex Rivers",planId:PLAN_ID,planName:"Momentum review",status:"active",accessStatus:"active",requiredDiscordRoleId:"910002",requiredRolePresent:true,requestedAtUtc:"2026-08-12T14:30:00.000Z",startedAtUtc:"2026-08-12T15:00:00.000Z",endedAtUtc:null,studentMessagingEnabled:true,studentTradeReviewsEnabled:true }]),
    ...
    tradeReviews:Object.freeze([{reviewId:"10000000-0000-4000-8000-000000000035",relationshipId:RELATIONSHIP_ID,requestedByUserId:STUDENT_ID,title:"Weekly execution review",studentContext:"Compare this week with last week and review the NVDA and AMD trades.",coachFeedback:"Your entries improved across the selected trades.",wentWell:"Entries were more selective and the first partial followed the plan.",needsWork:"Size was reduced before the planned first target.",nextFocus:"Hold planned size through the first target when the setup remains valid.",coachPrivateNotes:"Check whether the student continues reducing size early next week.",previousFocusStatus:"improving",previousFocusAssessment:"The student waited for confirmation on four of five entries.",status:"in_review",requestedAtUtc:"2026-09-05T13:08:00.000Z",completedAtUtc:null,updatedAtUtc:"2026-09-05T13:25:00.000Z",reviewType:"weekly",periodStart:"2026-09-01",periodEnd:"2026-09-05",roundTripIds:Object.freeze(["10000000-0000-4000-8000-000000000050","10000000-0000-4000-8000-000000000051"])},{reviewId:"10000000-0000-4000-8000-000000000065",relationshipId:RELATIONSHIP_ID,requestedByUserId:COACH_ID,title:"Previous weekly review",studentContext:"",coachFeedback:"Reviewed entry timing and confirmation.",wentWell:"",needsWork:"",nextFocus:"Wait for confirmation before entering the opening-range setup.",coachPrivateNotes:"",previousFocusStatus:null,previousFocusAssessment:"",status:"completed",requestedAtUtc:"2026-08-29T13:08:00.000Z",completedAtUtc:"2026-08-29T14:00:00.000Z",updatedAtUtc:"2026-08-29T14:00:00.000Z",reviewType:"weekly",periodStart:"2026-08-25",periodEnd:"2026-08-29",roundTripIds:Object.freeze([])}]),
    ...
    coachingSessions:Object.freeze([{sessionId:"10000000-0000-4000-8000-000000000052",relationshipId:RELATIONSHIP_ID,title:"Weekly review call",agenda:"Review execution consistency and next-week focus.",notes:"",scheduledAtUtc:"2026-09-08T18:00:00.000Z",completedAtUtc:null,status:"scheduled"}]),
    teachingItems:Object.freeze([{teachingId:"10000000-0000-4000-8000-000000000053",coachUserId:COACH_ID,title:"Building an opening-range plan",teachingType:"class",body:"Live class for all active students.",deliveryUrl:"https://discord.com/channels/900001/920003",scheduledAtUtc:"2026-09-10T18:00:00.000Z",status:"published",audienceMode:"all_students",planId:null,students:Object.freeze([{relationshipId:RELATIONSHIP_ID,status:"attending" as const,completedAtUtc:null}])}]),
    coachingAttachments:Object.freeze([]),
    reviewReplies:Object.freeze([{replyId:"10000000-0000-4000-8000-000000000055",reviewId:"10000000-0000-4000-8000-000000000035",authorUserId:STUDENT_ID,authorName:"Alex Rivers",body:"I can see the difference in the second entry. I will add it to next week's focus.",createdAtUtc:"2026-09-05T13:40:00.000Z"}]),
  ...
  return Object.freeze({...snapshot,
    ...
    tradeReviews:Object.freeze(snapshot.tradeReviews.filter(item=>relationshipIds.has(item.relationshipId)).map(item=>item.relationshipId===RELATIONSHIP_ID&&viewer.userId===STUDENT_ID?{...item,coachFeedback:item.status==="completed"?item.coachFeedback:"",wentWell:item.status==="completed"?item.wentWell:"",needsWork:item.status==="completed"?item.needsWork:"",nextFocus:item.status==="completed"?item.nextFocus:"",coachPrivateNotes:"",previousFocusStatus:item.status==="completed"?item.previousFocusStatus:null,previousFocusAssessment:item.status==="completed"?item.previousFocusAssessment:""}:item)),
    ...
    coachingSessions:Object.freeze(snapshot.coachingSessions.filter(item=>relationshipIds.has(item.relationshipId))),
    teachingItems:Object.freeze(snapshot.teachingItems.map(item=>({...item,students:Object.freeze(item.students.filter(student=>relationshipIds.has(student.relationshipId)))})).filter(item=>item.students.length>0)),
    coachingAttachments:Object.freeze(snapshot.coachingAttachments.filter(item=>relationshipIds.has(item.relationshipId))),
    reviewReplies:Object.freeze(snapshot.reviewReplies.filter(item=>snapshot.tradeReviews.some(review=>relationshipIds.has(review.relationshipId)&&review.reviewId===item.reviewId))),
