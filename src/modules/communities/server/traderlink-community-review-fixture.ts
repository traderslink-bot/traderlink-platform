...
export function createTraderLinkCommunityReviewFixture(): TraderLinkCommunityDashboardSnapshot {
  ...
  const snapshot: TraderLinkCommunityDashboardSnapshot = {
    ...
    relationships: Object.freeze([{ relationshipId:RELATIONSHIP_ID,communityId:COMMUNITY_ID,coachProfileId:COACH_PROFILE_ID,coachUserId:COACH_ID,coachDisplayName:"Maya Chen",studentUserId:STUDENT_ID,studentDisplayName:"Alex Rivers",planId:PLAN_ID,planName:"Momentum review",status:"active",requestedAtUtc:"2026-08-12T14:30:00.000Z",startedAtUtc:"2026-08-12T15:00:00.000Z",endedAtUtc:null }]),
