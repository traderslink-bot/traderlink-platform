      ...
      Object.freeze({
        ...
        blocks: Object.freeze([
          Object.freeze({ kind: "bullets", items: Object.freeze([
            ...
            "Use Around trade to return to the execution-centered view, or All candles to fit every candle already saved for the available session. All candles does not fetch later market data.",
            "Use Display to show or hide Volume, Executions, Rules, Candle patterns, VWAP and EMA. An unavailable item explains which saved chart fact is missing.",
            "Use Fullscreen to enlarge only the chart and its controls. These display choices do not change the saved trade or Trade Analyzer conclusions.",
  ...
  Object.freeze({
    ...
    sections: Object.freeze([
      Object.freeze({
        ...
        summary: "Understand Analyzer market data and execution importing as separate workflows.",
        keywords: Object.freeze(["moomoo", "market data", "execution imports"]),
        blocks: Object.freeze([
          Object.freeze({ kind: "callout", title: "Market data and execution imports are separate", text: "Importing broker executions is a separate permission and workflow from Analyzer market data." }),
