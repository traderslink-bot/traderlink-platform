  ...
  Object.freeze({
    ...
    sections: Object.freeze([
      Object.freeze({
        ...
        blocks: Object.freeze([
          Object.freeze({ kind: "paragraph" as const, text: "Ask AI Chat to change your reporting currency, mark one exact notification read, choose which updates go to Discord, turn existing AI Reviews on or off, switch to an existing Trade Tracker account, create a new Trade Tracker account, change the tags on one exact completed trade, or add and manage a Trading Rule. Chat checks the current value or target before it prepares anything." }),
