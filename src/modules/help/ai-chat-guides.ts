    ...
    sections: Object.freeze([
      ...
      Object.freeze({
        ...
        blocks: Object.freeze([
          ...
          Object.freeze({ kind: "paragraph" as const, text: "You can also ask about saved Trade Analyzer results, an existing Candle Review, recent imports, Data Decisions, notifications, account settings and whether a Moomoo connection or automatic import is set up." }),
    ...
    sections: Object.freeze([
      ...
      Object.freeze({
        ...
        blocks: Object.freeze([
          ...
          Object.freeze({ kind: "paragraph" as const, text: "For Trading Days, Tickers, Entry Times, Holding Time, Share Size, Position Size or Periods, ask Links AI Chat to use one supported result and say whether you want the highest or lowest groups first. Results stay separate by currency and trading timezone when they cannot be combined truthfully." }),
          Object.freeze({ kind: "paragraph" as const, text: "Links AI Chat can explain the saved note, tags and rule results for one exact completed trade. Trade Explorer shows those facts in Trade Details; use Session Tracker to edit the trade's note, tags and custom-rule results. Preset rule results remain read-only. A tag change prepared in Chat still shows an exact preview and changes nothing until you confirm it." }),
