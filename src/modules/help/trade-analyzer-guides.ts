...
export const TRADE_ANALYZER_HELP_GUIDES: readonly HelpGuide[] = Object.freeze([
  {
    ...
    sections: [{ id: "execution-context", title: "Execution context",
      ...
      keywords: ["EMA 9", "EMA 20", "RSI", "VWAP", "trend", "momentum"], blocks: [
        ...
        { kind: "paragraph", text: "Indicator context uses completed candles available before the execution, not the unfinished candle containing it. Earlier candle history is requested when needed during analysis and reused when available. EMA 9 can begin with nine completed candles and EMA 20 with twenty, using the selected timeframe. Earlier history helps the averages settle; a shorter history can produce a different value from a chart with more history loaded. Each execution and indicator is checked separately. Less frequently traded candles remain separate from regularly spaced candles. A missing candle alone does not prove low volume or a provider fault." },
        ...
        { kind: "paragraph", text: "Supporting trades shows the executions behind the selected comparison group, 25 at a time by default. View details expands the saved EMA, RSI and VWAP values, last completed candle, candle age and direction observation span. The whole-trade P/L repeats when a trade has several executions; do not add those rows together. Full analysis opens the saved trade and chart, keeping your selected candle timeframe and Gross/Net basis for that analysis. This does not change your account preference. If a date range has no analyzed trades, choose another period." },
      ...
      },
      {
        ...
        blocks: [
          ...
          { kind: "bullets", items: [
            ...
            "Choose Around trade to restore the execution-centered range, or All candles to fit every candle already saved for the available session. All candles does not request new market data.",
            "Open Display to show or hide Volume, Executions, Rules, Candle patterns, VWAP and EMA. A disabled item explains why that saved layer is unavailable.",
            "Use Fullscreen to enlarge only the chart and its controls. Display choices are temporary and never change Analyzer evidence or conclusions.",
    ...
    sections: [
      {
        ...
        keywords: ["EMA 9", "EMA 20", "RSI", "initial entry", "add", "partial exit"], blocks: [
          ...
          { kind: "paragraph", text: "An account with an explicit owner testing exemption shows Unlimited instead of remaining uses. It has no daily, period or manual-retry quantity limit. Requests still wait their turn for the shared data connection, and duplicate requests do not start another analysis." },
    ...
    sections: [
      ...
      },
      {
        ...
        blocks: [
          ...
          { kind: "paragraph", text: "The saved execution and market-data evidence remains visible for review. TradersLink does not manufacture a trade-outcome conclusion from ordinary volatility." },
    ...
    sections: [
      ...
      },
      {
        ...
        blocks: [
          ...
          { kind: "paragraph", text: "The replay focuses the selected execution at the saved 1-minute or 5-minute timeframe. Previous and Next move through the visible occurrence page. Open Session Tracker keeps the exact trade, execution, interval and Gross/Net selection for the full review. A trade you grouped together remains one complete trade." },
    ...
    sections: [
      ...
      },
      {
        ...
        blocks: [
          ...
          { kind: "paragraph", text: "Trend & Momentum counts only analyzed trades, not your full imported trade history. The page count follows your selected period and direction. Each table shows how many analyzed trades have the data needed for that comparison; an unavailable indicator does not erase the trade's other analysis. The Day overview card includes both long and short analyzed trades in the selected period." },
    ...
    sections: [
      {
        ...
        summary: "Treat Analyzer market data and execution imports as separate workflows.",
        keywords: ["moomoo", "market data", "execution imports", "saved candles"],
        blocks: [
          { kind: "paragraph", text: "Automatic execution imports require a supported trading account. Manual entry and statement imports remain available when broker importing is unavailable." },
        ],
      },
      {
