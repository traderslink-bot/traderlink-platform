  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        keywords: ["compression", "engulfing", "expansion", "hammer", "shooting star", "wick rejection", "exhaustion"],
        blocks: [
          { kind: "table", columns: ["Pattern", "Completed evidence"], rows: [
            ...
            ["Bullish / Bearish compression break", "Price closed decisively above or below a confirmed compressed range on increased activity."],
            ["Bullish / Bearish engulfing shift", "A meaningful body fully engulfed the preceding opposite-direction body."],
            ["Bullish / Bearish expansion", "Range and body expanded materially and closed near the directional extreme."],
            ["Confirmed Hammer", "After a meaningful decline, a dominant lower wick rejected a local low and the next candle confirmed recovery."],
            ["Confirmed Shooting Star", "After a meaningful advance, a dominant upper wick rejected a local high and the next candle confirmed weakness."],
            ["Lower-wick / Upper-wick rejection", "Price tested a local extreme, left a dominant wick and closed away from that extreme."],
            ["Possible high-volume exhaustion", "An extended move stalled at a local extreme on exceptional volume and the following candle confirmed failure."],
          ] },
          { kind: "paragraph", text: "Hammer, Shooting Star and possible exhaustion require a following completed candle. A familiar-looking candle correctly receives no label when its measured structure, local context or confirmation is missing." },
        ],
      },
    ],
  },
