...
test("pattern population binds current grouped result revision and whole-trade P/L after final-close selection", (t) => {
  ...
  t.mock.method(LogicalTradeAnalyzerRepository.prototype, "readCurrentByRoundTrip", () => ready);
...
test("pending grouped analysis cannot be replaced by member snapshots and cross-account reads are rejected", (t) => {
  t.mock.method(JournalLogicalTradeRepository.prototype, "list", () => [trade]);
  t.mock.method(LogicalTradeAnalyzerRepository.prototype, "readCurrentByRoundTrip", () => ({ status: "pending", analyzed: null }));
