// 2026-04-14
// PURPOSE:
// Detects the stronger confirmed pivot candidates for the support/resistance
// lane using the repo's "strict pivot" definition.
...
import type { DetectedPivot } from "./detect-tight-pivots";
...
export function detectStrictPivots(candles: Candle[]): DetectedPivot[] {
  const window = SUPPORT_RESISTANCE_CONFIG.strictPivotWindow;
