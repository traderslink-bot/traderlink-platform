...
export type ContentIdentityDomain =
  ...
  | "server_execution_analytics_authority"
  | "server_execution_analytics_governed_result"
  | "execution_analytics_dashboard_query_packet"
  | "execution_analytics_dashboard_evidence_page_packet"
  ...
  | "trade_query_distribution_result"
  | "trade_query_finding_packet"
  | "trade_query_continuation"
  | "trade_query_page"
