...
export function createValidationIbkrClient() {
    const clientId = resolvePositiveInteger(process.env.LEVEL_VALIDATION_IBKR_CLIENT_ID) ??
        DEFAULT_IBKR_CLIENT_ID;
    const port = resolvePositiveInteger(process.env.LEVEL_VALIDATION_IBKR_PORT) ??
        DEFAULT_IBKR_PORT;
    const host = process.env.LEVEL_VALIDATION_IBKR_HOST?.trim() ||
        DEFAULT_IBKR_HOST;
